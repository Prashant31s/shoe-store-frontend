    ...
    <div className="w-full md:py-20">
         ...
         <div className="flex flex-col lg:flex-row gap-12 py-10">
              ...
              <div className="flex-[1]">
                   ...
                   active:scale-95 mb-3 hover:opacity-75 flex items-center gap-2 justify-center" onClick={handlePayment}>
                            Checkout 
         ...
         {cartItems.length<1 && <div className="flex-[2] flex flex-col items-center pb-[50px] md:mt-14">
              ...
              transition-transform active:scale-95 mb-3 hover:opactity-75 mt-8"
              >
                Continue Shopping 
              </Link>
